/**
 * Custom hook for managing 3DS authentication for debit cards.
	...
	const authenticate = useCallback(
		async (params: ThreeDSAuthenticateParams): Promise<ThreeDSResult> => {
			...
			try {
				...
				// Build the authentication request for DEBIT_CARD
				const request: PagSeguro3DSAuthenticationRequest = {
					data: {
						...
						paymentMethod: {
							type: "DEBIT_CARD", // Debit card type
							installments: 1, // Always 1 for debit
							card: {
