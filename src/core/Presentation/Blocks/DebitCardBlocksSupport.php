	...
	public function get_payment_method_data() {
		...
		return array(
			...
			'messages'                => array(
				...
				'invalid_encrypted_card'        => __( 'O cartão de débito criptografado não foi encontrado.', 'pagbank-for-woocommerce' ),
				'invalid_card_bin'              => __( 'O bin do cartão de débito não foi encontrado.', 'pagbank-for-woocommerce' ),
				// 3DS messages.
				...
				'threeds_not_supported'         => __( 'O cartão de débito não pode ser autenticado. Use outro método de pagamento.', 'pagbank-for-woocommerce' ),
			),
		);
	}
